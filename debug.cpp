...
home:
    ...
    tabg:
        system("cls");
        cout << "+-----------------------------------------------------------------------+\n";
        cout << "|" << setiosflags(ios::right) << setw(50) << "Menu Menabung" << setiosflags(ios::right) << setw(23) << "|\n";
        cout << "+-----------------------------------------------------------------------+\n";
        cout << endl;
        int i;
        for (i = 0; i < x; i++)
        ...
        cout << endl;
        string tab;
        cout << "masukan nama yang ingin menabung =";
        cin >> tab;
        bool tabung = false;
        for (i = 0; i < x; i++)
        {
            if (tab == member.nama[i])
            {
                cout << "Informasi" << endl;
                cout << "Nama akun      = " << member.nama[i] << endl;
                cout << "Saldo Tabungan = " << member.tabungan[i] << endl;
                cout << "Kitas          = " << member.kitas[i] << endl;
                cout << endl;
                double baru;
                cout << "Masukan Jumlah Uang yang akan ditabung = ";
                cin >> baru;
                member.tabungan[i] = baru + member.tabungan[i];
                tabung = true;
                cout << endl;
                cout << "berhasil menambahkan tabungan " << endl;
                cout << endl;
                cout << endl;
                for (i = 0; i < x; i++)
                {
        ...
        if (tabung == false)
        {
            cout << "nama yang anda masukan salah , tolong masukan nama yang benar !!!" << endl;
            system("pause");
            goto tabg;
        }
    }
